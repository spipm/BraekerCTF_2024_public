...
This is the source code from the [BraekerCTF](https://ctftime.org/event/2181) 2024 by spipm (sipke@factosec.nl). It is a jeopardy-style hacking competition, and it ran from 23 February 2024 to 24 February 2024. Status can be found [here](./stats.md).
